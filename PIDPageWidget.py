...
class PIDPageWidget(QWidget):
    ...
    def updatePage(self):
        ...
        if self.dataEventPIDInfo.hasBeenUpdated():
            data = self.dataEventPIDInfo.get()
    ...
    def processTelemetryPIDData(self, data):
        self.fxControlCurveData.set(QTHelpers.appendAndResizeCurveData(self.fxControlCurveData.get(), [x.control[PIDIndexMap.Fx] for x in data], self.maxPlotSize))
        self.fyControlCurveData.set(QTHelpers.appendAndResizeCurveData(self.fyControlCurveData.get(), [x.control[PIDIndexMap.Fy] for x in data], self.maxPlotSize))
        self.fzControlCurveData.set(QTHelpers.appendAndResizeCurveData(self.fzControlCurveData.get(), [x.control[PIDIndexMap.Fz] for x in data], self.maxPlotSize))
        self.mxControlCurveData.set(QTHelpers.appendAndResizeCurveData(self.mxControlCurveData.get(), [x.control[PIDIndexMap.Mx] for x in data], self.maxPlotSize))
        self.myControlCurveData.set(QTHelpers.appendAndResizeCurveData(self.myControlCurveData.get(), [x.control[PIDIndexMap.My] for x in data], self.maxPlotSize))
        self.mzControlCurveData.set(QTHelpers.appendAndResizeCurveData(self.mzControlCurveData.get(), [x.control[PIDIndexMap.Mz] for x in data], self.maxPlotSize))
