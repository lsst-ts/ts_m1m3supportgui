...
class MTM1M3Remote:
    def __init__(self):
        ...
        self.sal.salEvent("MTM1M3_logevent_settingVersions")
        self.sal.salEvent("MTM1M3_logevent_errorCode")
        self.sal.salEvent("MTM1M3_logevent_summaryState")
        self.sal.salEvent("MTM1M3_logevent_appliedSettingsMatchStart")
        self.sal.salEvent("MTM1M3_logevent_accelerometerWarning")
        self.sal.salEvent("MTM1M3_logevent_airSupplyStatus")
        self.sal.salEvent("MTM1M3_logevent_airSupplyWarning")
        ...
        self.sal.salEvent("MTM1M3_logevent_appliedHardpointSteps")
        ...
        self.sal.salEvent("MTM1M3_logevent_cellLightStatus")
        self.sal.salEvent("MTM1M3_logevent_cellLightWarning")
        self.sal.salEvent("MTM1M3_logevent_detailedState")
        self.sal.salEvent("MTM1M3_logevent_displacementSensorWarning")
        self.sal.salEvent("MTM1M3_logevent_forceActuatorBackupCalibrationInfo")
        self.sal.salEvent("MTM1M3_logevent_forceActuatorILCInfo")
        self.sal.salEvent("MTM1M3_logevent_forceActuatorIdInfo")
        self.sal.salEvent("MTM1M3_logevent_forceActuatorMainCalibrationInfo")
        self.sal.salEvent("MTM1M3_logevent_forceActuatorMezzanineCalibrationInfo")
        self.sal.salEvent("MTM1M3_logevent_forceActuatorPositionInfo")
        self.sal.salEvent("MTM1M3_logevent_forceActuatorState")
        self.sal.salEvent("MTM1M3_logevent_forceActuatorWarning")
        self.sal.salEvent("MTM1M3_logevent_gyroWarning")
        ...
        self.sal.salEvent("MTM1M3_logevent_hardpointMonitorState")
        self.sal.salEvent("MTM1M3_logevent_hardpointMonitorWarning")
        self.sal.salEvent("MTM1M3_logevent_inclinometerSensorWarning")
        self.sal.salEvent("MTM1M3_logevent_interlockStatus")
        self.sal.salEvent("MTM1M3_logevent_interlockWarning")
        self.sal.salEvent("MTM1M3_logevent_modbusResponse")
        self.sal.salEvent("MTM1M3_logevent_modbusWarning")
        self.sal.salEvent("MTM1M3_logevent_pidInfo")
        self.sal.salEvent("MTM1M3_logevent_powerStatus")
        self.sal.salEvent("MTM1M3_logevent_powerWarning")
        ...
        self.sal.salTelemetrySub("MTM1M3_forceActuatorPressure")
        ...
        self.sal.salTelemetrySub("MTM1M3_powerData")
